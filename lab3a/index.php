...
<section class="section">
    ...
    <form method="POST" action="instructions.php">
        ...
        <div class="field">
            ...
            <div class="control">
                <input class="input" name="birthdate" type="date" placeholder="Date" required />
            </div>
        </div>
        ...
        <div class="field">
            ...
            <div class="control">
                <input class="input" name="contact_number" type="number" placeholder="Contact Number" required />
            </div>
        </div>
